...
const Banner = () => {
    return (
      <>
        <div className="pt-28 flex relative flex-col text-center md:text-left text-white gap-6 p-8">
          <video
            autoPlay
            loop
            muted
            className="absolute left-0 top-0 -z-10 brightness-50   mt-12  h-full md:h-[75vh]
