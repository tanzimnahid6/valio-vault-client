...
const Banner = () => {
    return (
      <div className="pt-28 flex flex-col text-center md:text-left text-white gap-6 p-8">
        <video autoPlay loop muted  className="absolute left-0 top-0 -z-10 brightness-50   mt-16 h-full md:h-[75vh]
        ...
        <p className="md:text-xl text-gray-300">
          ...
          Achieve <br /> smart exposure to Web3 finance, without making it your full
          time job.
        </p>
        <p className="md:text-xl text-gray-300">
          Or… Do you think you’re good at making money onchain? Become <br /> a manager
          on Valio and earn fees! Built on
        </p>
